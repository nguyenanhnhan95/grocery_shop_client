...
export const checkFileSize = (value) => {
    if (value) {
        console.log(value)
        // You can add additional validations here like file type or file size
        return value.size <= 10000000; // Example: file size less than 2MB
    }
    return false;
};
